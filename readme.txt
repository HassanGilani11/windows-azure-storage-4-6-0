...
= 4.6.0 =
* **Added:** "Test Connection" button on the settings screen to verify the Storage Account Name and Primary Access Key against Microsoft Azure Storage before saving.
